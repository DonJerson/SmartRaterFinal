...
<p className="" style={{marginLeft:10,height: 22, fontSize: 24, fontWeight: '700', 
lineHeight: '100%', color: 'white',}}>Quoted on 10/07/2021</p>
...
function Body(props){
  console.log("props",props.quoteId)
  let quote = {}
  try {
    quote =   props.userPack.user.quoteList.filter(quote=>quote.id==props.quoteId);
  } catch (error) {
    quote.businessType='';
  }
  ...
  console.log("quote",quote)
    return(
        ...
        paddingBottom:"18px"}}>
              {/* <AutoQuote/> */}
              <AutoQuote quote={props.userPack.user.quoteList[0]}/>
            </div>
    ...
    return(
        <>
            ...
            {false?
              ...
              <Body quoteId={props.quoteId} userPack={props.userPack}/>
